  ...
  const capCategories = [
    {
      ...
      color: "Black",
      description:
        "Traditional baseball cap with curved brim, perfect for everyday wear",
      accent: "#a78bfa",
    },
    {
      id: 2,
  ...
  return (
    <>
      <style>{`
        ...
        .cap-nav-left { left: -22px; }
        .cap-nav-right { right: -22px; }
        ...
        .cap-track:active { cursor: grabbing; }
        ...
        .cap-card:hover .cap-card-img-wrap img {
          transform: scale(1.05);
        }

        .cap-card-img-overlay {
          position: absolute;
          inset: 0;
        ...
        .cap-card:hover .cap-card-accent-line {
          transform: scaleX(1);
        }
      ...
      <section className="cap-section">
        ...
        >
          ...
          >
            <div className="cap-label">Headwear Collection</div>
            <h2 className="cap-title">
              Shop by <em>Cap Categories</em>
            </h2>
            <p className="cap-subtitle">
              Explore our premium cap collection — stylish, comfortable, and
              perfect for custom embroidery and prints.
            </p>
          </motion.div>
          ...
          >
            {showLeftArrow && (
              <button
                className="cap-nav-btn cap-nav-left"
                onClick={() => scroll("left")}
            ...
            {showRightArrow && (
              <button
                className="cap-nav-btn cap-nav-right"
            ...
            >
              <div className="cap-cards">
                {capCategories.map((cap, index) => (
                  ...
                  >
                    {/* Image */}
                    <Link to={`/products/cap/${cap.id}`}>
                      <div className="cap-card-img-wrap">
                        <img src={cap.image} alt={cap.name} draggable="false" />
                        <div className="cap-card-img-overlay" />
                        <span className="cap-badge">{cap.badge}</span>
                        <span className="cap-color-dot">{cap.color}</span>
                      </div>
                    </Link>
                    ...
                    <div className="cap-card-body">
                      <Link
                        to={`/products/cap/${cap.id}`}
                        style={{ textDecoration: "none" }}
                      >
                        <div className="cap-card-name">{cap.name}</div>
                      </Link>
                    ...
                    <div className="cap-card-accent-line" />
                  </motion.div>
                ))}
              </div>
            </div>
          ...
          <div className="cap-dots">
            {[0, 1, 2, 3, 4].map((i) => (
              <div key={i} className={`cap-dot ${i === 0 ? "active" : ""}`} />
            ))}
          </div>
          ...
          >
            <Link to="/products" className="cap-all-btn">
              View All Caps
              <svg
                width="14"
                height="14"
