              ...
              <div className="pc-cards">
                {mugCategories.map((mug, index) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    className="pc-card"
                    onMouseEnter={() => setActiveCard(mug.id)}
                    onMouseLeave={() => setActiveCard(null)}
                  >
                    {/* Image */}
                    <Link to={`/products/mug/${mug.id}`}>
                      <div className="pc-card-img-wrap">
                        <img src={mug.image} alt={mug.name} draggable="false" />
                        <div className="pc-card-img-overlay" />
                        <span className="pc-badge">{mug.badge}</span>
                        <span className="pc-color-dot">{mug.color}</span>
                      </div>
                    </Link>
                    ...
                    <div className="pc-card-body">
                      <Link
                        to={`/products/mug/${mug.id}`}
                        style={{ textDecoration: "none" }}
                      >
                        <div className="pc-card-name">{mug.name}</div>
                      </Link>
                      <p className="pc-card-desc">{mug.description}</p>
