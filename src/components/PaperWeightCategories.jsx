...
const PaperweightCategories = () => {
  ...
  const paperweightCategories = [
    {
      id: 1,
      name: "MDF Paperweight",
      image: "./PaperweightImages/MDFPaperweight.jpeg",
      badge: "Best Seller",
      color: "MDF Wood",
      description: "Eco-friendly MDF paperweight perfect for corporate gifts",
      accent: "#a78bfa",
    },
    {
      id: 2,
      name: "Wooden Paperweight",
      image: "./PaperweightImages/WoodenPaperweight.jpeg",
      badge: "Premium",
      color: "Natural Wood",
      description: "Premium natural wooden paperweight with elegant finish",
      accent: "#f472b6",
    },
    {
      id: 3,
      name: "Acrylic Paperweight",
      image: "./PaperweightImages/AcrylicPaperweight.jpeg",
      badge: "Trending",
      color: "Crystal Clear",
        ...
        >
          ...
          >
            ...
            <h2 className="pc-title">
              Shop by <em>Paperweight Categories</em>
            </h2>
            <p className="pc-subtitle">
              Explore our curated paperweight collection — each piece crafted
              for personalisation and gifting.
            </p>
          </motion.div>
          ...
          >
            <Link to="/products/paperweights" className="pc-all-btn">
              View All Paperweights
              <svg
                width="14"
                height="14"
                fill="none"
...
export default PaperweightCategories;
