      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center">
          ...
          >
            ...
            {showLeftArrow && (
              <button
                className="absolute top-1/2 -translate-y-1/2 z-20 w-10 h-10 md:w-11 md:h-11 rounded-full border border-white/10 bg-white/5 backdrop-blur-md text-white cursor-pointer flex items-center justify-center transition-all hover:bg-purple-600 hover:border-purple-600 hover:scale-105 -left-3 sm:-left-4 md:-left-5"
                onClick={() => scroll("left")}
            ...
            {showRightArrow && (
              <button
                className="absolute top-1/2 -translate-y-1/2 z-20 w-10 h-10 md:w-11 md:h-11 rounded-full border border-white/10 bg-white/5 backdrop-blur-md text-white cursor-pointer flex items-center justify-center transition-all hover:bg-purple-600 hover:border-purple-600 hover:scale-105 -right-3 sm:-right-4 md:-right-5"
                  ...
                  >
                    ...
                    <div className="p-5">
                      <Link to={`/products/gift/${gift.id}`} className="block">
                        <h3 className="font-['Playfair_Display',serif] text-lg font-semibold text-white mb-2 text-center">
                          {gift.name}
                        </h3>
                      </Link>
