...
const CooperativeGiftCategories = () => {
  ...
  const cooperativeGiftCategories = [
    {
      ...
      image: "./MainGiftImage/CorporateGiftBox.jpeg",
      badge: "Best Seller",
      color: "Premium",
      description:
    ...
    },
    {
      id: 2,
      name: "Festive Hamper",
      image: "./MainGiftImage/FestiveHamper.jpeg",
      badge: "Trending",
      color: "Festive",
      description:
    ...
    },
    {
      ...
      image: "./MainGiftImage/CustomGiftSet.jpeg",
      badge: "Premium",
      color: "Custom",
      description:
  ...
  // Auto-scroll logic - disabled for 3 items as they fit on screen
  useEffect(() => {
    let interval;
    if (
      isAutoScrolling &&
      scrollContainerRef.current &&
      cooperativeGiftCategories.length > 3
    ) {
  ...
  return (
    <>
      <style>{`
        ...
        .gift-nav-left { left: -22px; }
        .gift-nav-right { right: -22px; }
        ...
        .gift-track:active { cursor: grabbing; }
        .gift-track::-webkit-scrollbar { display: none; }
        ...
        .gift-card:hover .gift-card-accent-line {
          transform: scaleX(1);
        }
      ...
      <section className="gift-section">
        ...
        >
          ...
          >
            <div className="gift-label">Gifting Collection</div>
            <h2 className="gift-title">
              Shop by <em>Cooperative Gift Categories</em>
            </h2>
            <p className="gift-subtitle">
              Discover our premium gift collection — perfect for corporate
          ...
          >
            {showLeftArrow && (
              <button
                className="gift-nav-btn gift-nav-left"
                onClick={() => scroll("left")}
            ...
            {showRightArrow && (
              <button
                className="gift-nav-btn gift-nav-right"
              ...
              <div className="gift-cards">
                {cooperativeGiftCategories.map((gift, index) => (
                  ...
                  >
                    ...
                    <Link to={`/products/gift/${gift.id}`}>
                      <div className="gift-card-img-wrap">
                        <img
                          ...
                          draggable="false"
                        />
                        <div className="gift-card-img-overlay" />
                        <span className="gift-badge">{gift.badge}</span>
                        <span className="gift-color-dot">{gift.color}</span>
                      </div>
                    </Link>
                    ...
                    <div className="gift-card-accent-line" />
                  </motion.div>
                ))}
              </div>
            </div>
          ...
          {/* Dots - only 3 dots for 3 items */}
          <div className="gift-dots">
            {cooperativeGiftCategories.map((_, i) => (
              <div key={i} className={`gift-dot ${i === 0 ? "active" : ""}`} />
            ))}
          </div>
          ...
          >
            <Link to="/products" className="gift-all-btn">
              View All Gifts
              <svg
                width="14"
                height="14"
