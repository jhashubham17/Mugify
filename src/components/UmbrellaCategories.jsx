...
const UmbrellaCategories = () => {
  ...
  const umbrellaCategories = [
    ...
    },
    {
      ...
      color: "Various",
      description:
        "Classic three-fold design balancing portability and coverage",
      accent: "#34d399",
    },
    {
      id: 4,
      name: "Capsule Umbrella",
      image: "./MainMugImage/CapsuleUmbrella.jpeg",
      badge: "Trending",
      color: "Various",
      description: "Innovative capsule-shaped case for ultimate protection",
      accent: "#fb923c",
    },
    {
      id: 5,
      name: "Bottle Umbrella",
      image: "./MainMugImage/BottleUmbrella.jpeg",
      badge: "Unique",
      color: "Various",
      description: "Bottle-shaped design that stands out from the crowd",
      accent: "#818cf8",
    },
    {
      id: 6,
      name: "Banana Umbrella",
      image: "./MainMugImage/BananaUmbrella.jpeg",
      badge: "Fun Shape",
      color: "Various",
      description: "Playful curved handle design for easy carrying",
      accent: "#f43f5e",
    },
    {
      id: 7,
      name: "Automatic Umbrella",
      image: "./MainMugImage/AutomaticClose&OpenUmbrella.jpeg",
      badge: "Auto Open/Close",
      color: "Various",
      description: "One-touch automatic open and close mechanism",
      accent: "#22d3ee",
    },
    {
      id: 8,
      name: "Golf Umbrella",
      image: "./MainMugImage/PromotionalUmbrella.jpg",
      badge: "Oversized",
      color: "Various",
      description: "Extra-large canopy for maximum coverage on rainy days",
      accent: "#f59e0b",
    },
  ];
        ...
        >
          ...
          >
            ...
            <h2 className="pc-title">
              Shop by <em>Umbrella Categories</em>
            </h2>
            <p className="pc-subtitle">
              Explore our curated umbrella collection — perfect for every style
              and weather need.
            </p>
          </motion.div>
          ...
          >
            ...
            >
              <div className="pc-cards">
                {umbrellaCategories.map((umbrella, index) => (
                  <motion.div
                    key={umbrella.id}
                    ...
                    viewport={{ once: true }}
                    className="pc-card"
                    onMouseEnter={() => setActiveCard(umbrella.id)}
                    onMouseLeave={() => setActiveCard(null)}
                  >
                    {/* Image */}
                    <Link to={`/products/umbrella/${umbrella.id}`}>
                      <div className="pc-card-img-wrap">
                        ...
                        <span className="pc-badge">{umbrella.badge}</span>
                        <span className="pc-color-dot">{umbrella.color}</span>
                      </div>
                    </Link>
                    ...
                    <div className="pc-card-body">
                      <Link
                        to={`/products/umbrella/${umbrella.id}`}
                        style={{ textDecoration: "none" }}
                      >
                        <div className="pc-card-name">{umbrella.name}</div>
                      </Link>
                      <p className="pc-card-desc">{umbrella.description}</p>
          ...
          >
            <Link to="/products" className="pc-all-btn">
              View All Products
              <svg
                width="14"
                height="14"
...
export default UmbrellaCategories;
